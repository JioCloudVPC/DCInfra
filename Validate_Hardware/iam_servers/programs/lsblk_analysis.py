	...
	for line in f:
		...
		#split line into the words
			...
			if ">>" in line:
				...
				count = 0
			elif line.split()[0] == "sda":
				storage_dict["sda"] = line.split()[3] 
			elif "sda1" in line or "sda2" in line or "sda3" in line or "sda5"in line:
				count+=1
			elif line.split()[0] == "sdb":
				storage_dict["sdb"] = line.split()[3]

#Open a file for writing
out_file = open("../extracted_data/host_lsblk.json","w")
json.dump(lsblk_dict,out_file, sort_keys=False,indent=4)                                    
# Close the file
out_file.close()							